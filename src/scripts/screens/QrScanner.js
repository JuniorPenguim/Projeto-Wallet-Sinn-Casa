                ...
                >
                    <View style={styleClass.qrStyles.viewMaior}>
                        ...
                        <Text style={styleClass.qrStyles.textoDois}>
                            Esta é a sua <Text style={styleClass.qrStyles.textoDoisUm}>CHAVE PRIVADA, </Text>
                            não a
                        </Text>
                        <Text style={styleClass.qrStyles.textoTres}>entregue ou mostre para desconhecidos</Text>
                        <Text style={styleClass.qrStyles.textoQuatro}>e em ambientes cuja rede não seja</Text>
