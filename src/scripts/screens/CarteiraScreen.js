          ...
          <ImageBackground
            ...
            <View style={styleClass.carteiraStyles.viewMaior}>
              ...
              <View style={styleClass.carteiraStyles.viewBottom}>
                <Text style={styleClass.carteiraStyles.textoBottom}>{translate('carteiraDois')}{' '}
                  <Text style={styleClass.carteiraStyles.textoBottomUm}>{translate('carteiraDoisUm')}</Text>
                </Text>
                <TouchableWithoutFeedback
                  ...
                  <View>
                    ...
                    />
                    <Text style={styleClass.carteiraStyles.textoDocumento}>{translate('carteiraNovoDoc')}</Text>
                  </View>
                </TouchableWithoutFeedback>
              </View>
            </View>
