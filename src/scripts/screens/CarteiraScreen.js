                ...
                <Container>
                    ...
                    >
                        <View style={styleClass.carteiraStyles.viewMaior}>
                            ...
                            />
                            <Text style={styleClass.carteiraStyles.textoCarteira}>Minha carteira</Text>
                            <View style={styleClass.carteiraStyles.viewDocumentos} />
                            <View style={styleClass.carteiraStyles.viewBottom}>
                                <Text style={styleClass.carteiraStyles.textoBottom}>
                                    ...
                                    <Text style={styleClass.carteiraStyles.textoBottomUm}>wallet</Text>
                                </Text>
