      ...
      <Drawer
        ...
        <ImageBackground
          ...
          <View style={styleClass.politicaStyles.viewMaior}>
            ...
            <Text style={{fontSize: 0.022 * windowH,marginTop:hp('2%'), color:'white', marginLeft:wp('3%'), marginRight:wp('3%')}}>A Sinn.wallet foi desenvolvida pela Sinn Tecnologia, o aplicativo faz parte do nosso pacote de soluções de tecnologias disruptivas e do novo panorama de desenvolvimento da empresa.</Text>
            <View style={{flex: 1, justifyContent: 'flex-end'}}>
                <Text style={{ fontSize: 0.025 * windowH,marginTop:hp('1%'), color:'white', marginLeft:wp('3%'), marginRight:wp('3%')}}>ENTRE EM CONTATO CONOSCO EM CASO DE DÚVIDAS:</Text>
            </View>
